...
CREATE TABLE IF NOT EXISTS `glpi_plugin_formcreator_questions` (
  ...
  INDEX `edit_disabled` (`edit_disabled`),
  FULLTEXT KEY `Search` (`name`,`description`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_formcreator_targetchanges` (
  ...
  `commonitil_validation_question`   int unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_formcreator_targets_actors` (
  ...
  `actor_value`                      int unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_formcreator_items_targetchanges` (
  `id`                                 int unsigned NOT NULL AUTO_INCREMENT,
  `plugin_formcreator_targetchanges_id` int unsigned NOT NULL DEFAULT '0',
  `link`                               int(11)      NOT NULL DEFAULT '0',
  `itemtype`                           varchar(255) NOT NULL DEFAULT '',
  `items_id`                           int unsigned NOT NULL DEFAULT '0',
  `uuid`                               varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `glpi_plugin_formcreator_items_targetproblems` (
  `id`                                  int unsigned NOT NULL AUTO_INCREMENT,
  `plugin_formcreator_targetproblems_id` int unsigned NOT NULL DEFAULT '0',
  `link`                                int(11)      NOT NULL DEFAULT '0',
  `itemtype`                            varchar(255) NOT NULL DEFAULT '',
  `items_id`                            int unsigned NOT NULL DEFAULT '0',
  `uuid`                                varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `plugin_formcreator_targetproblems_id` (`plugin_formcreator_targetproblems_id`),
  INDEX `item` (`itemtype`,`items_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
